...
class PolicyUnlocker(lib2fas.UnlockerProtocol):
    ...
    def __init__(
        ...
        touch_timeout: float | None = None,
        session_cache: SessionCacheProtocol | None = None,
        keyring_manager: lib2fas.KeyringManagerProtocol | None = None,
        prompt: t.Callable[[str], str] | None = None,
        backend: t.Any = None,
    ) -> None:
        """
        Args:
